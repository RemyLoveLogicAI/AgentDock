...
import { Tool, ToolCollection, ToolExecutionOptions } from '../types';
...
const snowtracerSchema = z.object({
  ...
  address: z
    ...
    .optional()
    .describe(
      'Avalanche address to query (required for address-specific actions)'
    ),
  ...
  apiKey: z
    ...
    .optional()
    .describe(
      'Optional Snowtrace API key (will use environment variable if not provided)'
    )
});
