...
const COMPONENTS = {
  ...
  a: ({ node, href, children, ...props }: ComponentProps) => {
    ...
    const isInternalLink =
      typeof processedHref === 'string' && processedHref.startsWith('/');
  ...
  ol: ({ node, children, ...props }: ComponentProps) => {
    ...
    return (
      <ol
        className="list-decimal pl-6 marker:text-neutral-700"
        {...props}
      >
        {' '}
  ...
  ul: ({ node, children, ...props }: ComponentProps) => {
    ...
    return (
      <ul
        className="list-disc pl-6 marker:text-neutral-700"
        {...props}
      >
        {' '}
        {/* Spread remaining props */}
