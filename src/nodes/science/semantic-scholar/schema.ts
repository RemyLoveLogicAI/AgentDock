...
export const SemanticScholarSearchSchema = z.object({
  ...
  openAccess: z
    .boolean()
    .optional()
    .describe('Filter to only include open access papers'),
  venue: z
    .string()
    .optional()
    .describe('Filter by publication venue (journal or conference)'),
  fieldsOfStudy: z
    .string()
    .optional()
...
export const SemanticScholarAuthorFetchSchema = z.object({
  ...
  includePapers: z
    .boolean()
    .default(false)
    .describe("Include author's papers")
    .optional(),
  paperLimit: z
    .number()
    .int()
...
export type SemanticScholarSearchParameters = z.infer<
  typeof SemanticScholarSearchSchema
>;
export type SemanticScholarPaperFetchParameters = z.infer<
  typeof SemanticScholarPaperFetchSchema
>;
export type SemanticScholarAuthorFetchParameters = z.infer<
