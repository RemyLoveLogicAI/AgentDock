...
export class StepSequencer {
   ...
   */
  public async hasActiveSequence(
  ...
  public async getCurrentSequenceTool(
    ...
    const currentSequenceIndex = state.sequenceIndex ?? 0;
    return currentSequenceIndex < step.sequence.length
      ? step.sequence[currentSequenceIndex]
      : null;
  }
  ...
  public async advanceSequence(
    ...
    const currentIndex =
      state.sequenceIndex === undefined ? 0 : state.sequenceIndex;
    ...
    logger.debug(
      ...
      'Advanced sequence',
      {
        ...
        sequenceIndex: nextIndex,
        nextTool:
          nextIndex < step.sequence.length ? step.sequence[nextIndex] : 'end'
      }
    );
