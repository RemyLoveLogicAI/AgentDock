...
const formatBrainstorm = (ideas: string): string => {
  ...
  return (
    ideas
      ...
      .replace(
        /IDEAS:/g,
        '<span class="font-semibold text-foreground">IDEAS:</span>'
      )
      .replace(
      ...
      .replace(
        /KEY INSIGHTS:/g,
        '<span class="font-semibold text-foreground">KEY INSIGHTS:</span>'
      )
      .replace(
        /NEXT STEPS:/g,
        '<span class="font-semibold text-foreground">NEXT STEPS:</span>'
      )
