...
const imageGenerationSchema = z.object({
  prompt: z
    .string()
    .describe('Text prompt describing the image to generate or edit'),
  image: z
    .string()
    .optional()
    .describe(
...
export const imageGenerationTool: Tool = {
  name: 'generate_image',
  description:
    'Generate or edit images based on text prompts using Google Gemini',
  parameters: imageGenerationSchema,
  async execute(
    { prompt, image }: ImageGenerationParams,
